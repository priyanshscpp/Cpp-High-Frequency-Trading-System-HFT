...
class Trader {
 public:
  ...
  int handleCancelOrder(
      const std::function<std::pair<int, std::string>(std::string)>& action);
  int handlePlaceOrder(const std::function<std::pair<int, std::string>(
                           std::string, double, int)>& action);
  int handleModifyOrder(const std::function<std::pair<int, std::string>(
                            std::string, double, int)>& action);
  int handleGetOrderBook(
      const std::function<std::pair<int, std::string>(std::string, int)>&
          action);
  int handleViewPosition(
      const std::function<std::pair<int, std::string>(std::string)>& action);
  int handleOpenOrders(
      const std::function<std::pair<int, std::string>(std::string)>& action);
  int handleMarketData(
      const std::function<std::pair<int, std::string>(std::string, int)>&
          action);
